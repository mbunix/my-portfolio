    ...
    <div className='grid-background flex flex-col sm:flex-row items-center justify-between gap-4  mb-[3rem]  sm:mb-0'>
      <div className='flex flex-col gap-5 w-full sm:w-1/2'>
        <div>
          ...
          <h1 className='font-bold text-3xl sm:text-5xl sm:mt-3'>Bellian Otieno</h1>
        </div>
        <div>
          <p className='text-lg'>And i am talented Software Engineer</p>
          <p className='text-lg'>With a passion for creating elegant, robust, and scalable software systems.</p>
          <p className='text-lg'> My expertise spans above an beyond intutive software design and solid sytem architecture, </p>
          <p className='text-lg'> transforming design to implementation using the most appropriate technologies,</p>
          <p className='text-lg'>Implementing best practises in tackling software problems and always looking forward to learn new technologies.</p>
          <div>
            <a href="/Bellian.Otieno Resume.pdf" download>
